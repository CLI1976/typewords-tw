...
export const getDefaultBaseState = (): BaseState => ({
  ...
  word: {
    bookList: [
      ...
      getDefaultDict({ id: DictId.wordWrong, en_name: DictId.wordCollect, name: '錯詞' }),
      getDefaultDict({
        id: DictId.wordKnown,
        en_name: DictId.wordCollect,
        name: '已掌握',
        description: '已掌握後的單字不會出現在練習中',
      }),
    ],
    studyIndex: -1,
  },

...
const studyStats = $computed(() => {
  return {
    ...
    dictionary: baseStore.sdict.name || '未知詞書'
  }
})
...
const sentence = $computed(() => {
  let list = [
    { en: 'Actions speak louder than words.', cn: '行動勝於言語' },
    { en: 'Keep going, never give up!', cn: '堅持就是勝利' },
    { en: 'Where there\'s a will, there\'s a way.', cn: '有志者事竟成' },
    { en: 'Every cloud has a silver lining.', cn: '黑暗中總有一線光明' },
    { en: 'Time heals all wounds.', cn: '時間能治癒一切創傷' },
    { en: 'Never say die.', cn: '永不言敗' },
    { en: 'The best is yet to come.', cn: '最好的尚未到來' },
    { en: 'Believe you can and you\'re halfway there.', cn: '相信你自己，你已經成功了一半' },
    { en: 'No pain, no gain.', cn: '沒有付出就沒有收穫' },
    { en: 'Dream big and dare to fail.', cn: '大膽夢想，勇於失敗' },
    { en: 'Home is where the heart is.', cn: '心在哪裡，家就在哪裡' },
    { en: 'Knowledge is power.', cn: '知識就是力量' },
    { en: 'Practice makes perfect.', cn: '熟能生巧' },
    { en: 'When in Rome, do as the Romans do.', cn: '入境隨俗' },
    { en: 'Just do it.', cn: '只管去做' },
    { en: 'So far, so good.', cn: '到目前為止，一切還好' },
    { en: 'The early bird catches the worm.', cn: '早起的鳥兒有蟲吃' },
    { en: 'Every day is a new beginning.', cn: '每一天都是新的開始' },
    { en: 'Success is a journey, not a destination.', cn: '成功是旅程，不是終點' },
    { en: 'Your only limit is your mind.', cn: '你唯一的限制是你的思維' },
    { en: 'A friend in need is a friend indeed.', cn: '患難見真情' },
    { en: 'Silence is golden.', cn: '沉默是金' },
    { en: 'Let bygones be bygones.', cn: '讓過去的成為過去' },
    { en: 'Keep calm and carry on.', cn: '保持冷靜，繼續前進' },
    { en: 'Live and learn.', cn: '活到老，學到老' },
    { en: 'Mistakes are proof that you are trying.', cn: '錯誤證明你在努力嘗試' },
    { en: 'Better late than never.', cn: '遲做總比不做好' },
    { en: 'Be the change you wish to see in the world.', cn: '成為你希望在世界上看到的改變' },
    { en: 'The journey of a thousand miles begins with a single step.', cn: '千里之行，始於足下' },
    { en: 'When one door closes, another opens.', cn: '當一扇門關閉時，另一扇會打開' },
  ]
          ...
          <div class="flex flex-col flex-1 space-y-3">
            ...
            <div class="bg-gray-900/30 py-4 center flex-col rounded-2xl">
              <div class="text-center mb-2 text-xl">
                我學習了{{ studyStats.time }} {{ baseStore.sdict.name }}
              </div>
              <!-- Progress Overview -->
              <div class="w-90/100 flex items-center gap-space">
                <div class="shrink-0">進度</div>
          ...
          <div class="bg-gray-900/30 py-4 rounded-2xl p-4">
            <div class="flex justify-between items-end">
              <div class="space-y-2">
                ...
                <div class="text-xs  ">一次敲擊，一點進步，開源單字學習工具</div>
              </div>
      ...
      <div class="flex-1 pt-0 ">
        <div class="">
          ...
          <div class="flex items-start">
            <span class="mr-2">🚀</span>
            在 {{ APP_NAME }}，學習英語也能成為超酷的事情！
          </div>
          <div class="flex items-start">
            <span class="mr-2">📸</span>
            快來分享你的學習圖片，讓你的進步刷爆朋友圈，成為最受矚目的英語學霸！😎
          </div>
          <div class="flex items-start">
            <span class="mr-2">💪</span>
            這不只是簡單的打卡，更是你秀出英語實力的舞台！
          </div>
          <div class="flex items-start">
            <span class="mr-2">🔥</span>
            分享你的學習記錄，收穫朋友們的按讚和認可，讓你的朋友圈也掀起一股英語學習的熱潮！
          </div>
        </div>
        ...
        <div class="space-y-4 mt-24">
          ...
          <div @click="copyImageToClipboard"
            ...
            <span class="font-medium">複製到剪貼簿</span>
          </div>
          ...
          <div @click="downloadImage"
            ...
            <span class="font-medium">儲存高畫質海報</span>
          </div>
        </div>
      </div>
    </div>
